...
import { editExpenditure } from '../../actions';
...
export class EditExpenditure extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      artistKey: this.props.item.artistKey,
      artistName: [],
      amountOfMoney: this.props.item.amountOfMoney,
      amountOfMoneyWithComma: this.props.item.amountOfMoney,
...
const mapDispatchToProps = dispatch => {
  return {
    onEditExpenditure: expenditure => dispatch(editExpenditure(expenditure)),
  };
};
